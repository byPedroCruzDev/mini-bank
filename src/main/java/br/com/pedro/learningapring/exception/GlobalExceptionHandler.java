package br.com.pedro.learningapring.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAppException(final AppException ex, final WebRequest request) {
        ...
        returnObject.put("message", message.getMessage("message." + ex.getMessage(), null, request.getLocale()));
